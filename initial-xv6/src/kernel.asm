...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 c0 76 10 80 	movl   $0x801076c0,(%esp)
...
80102322:	81 fb 08 55 11 80    	cmp    $0x80115508,%ebx
...
80102eb7:	68 08 55 11 80       	push   $0x80115508
...
8010402b:	68 c0 76 10 80       	push   $0x801076c0
...
801049d4:	68 78 76 10 80       	push   $0x80107678
...
801049ec:	68 77 76 10 80       	push   $0x80107677
...
80104a05:	68 6b 76 10 80       	push   $0x8010766b
...
80104a1a:	68 7a 76 10 80       	push   $0x8010767a
80104a1f:	e8 6c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a24:	83 ec 0c             	sub    $0xc,%esp
80104a27:	68 5c 76 10 80       	push   $0x8010765c
...
80104b03:	83 ec 24             	sub    $0x24,%esp
  acquire(&readslock);
80104b06:	68 80 4c 11 80       	push   $0x80114c80
80104b0b:	e8 30 f8 ff ff       	call   80104340 <acquire>
  reads = reads+1;
80104b10:	83 05 bc a5 10 80 01 	addl   $0x1,0x8010a5bc
  release(&readslock);
80104b17:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
80104b1e:	e8 dd f8 ff ff       	call   80104400 <release>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104b23:	8d 55 ec             	lea    -0x14(%ebp),%edx
80104b26:	31 c0                	xor    %eax,%eax
80104b28:	e8 13 ff ff ff       	call   80104a40 <argfd.constprop.0>
80104b2d:	83 c4 10             	add    $0x10,%esp
80104b30:	85 c0                	test   %eax,%eax
80104b32:	78 4c                	js     80104b80 <sys_read+0x80>
...
80104b47:	78 37                	js     80104b80 <sys_read+0x80>
...
80104b5f:	78 1f                	js     80104b80 <sys_read+0x80>
...
80104b9b:	e8 a0 fe ff ff       	call   80104a40 <argfd.constprop.0>
...
80104c0c:	e8 2f fe ff ff       	call   80104a40 <argfd.constprop.0>
...
80104c5b:	e8 e0 fd ff ff       	call   80104a40 <argfd.constprop.0>
...
80104e39:	58                   	pop    %eax
80104e3a:	5a                   	pop    %edx
80104e3b:	68 78 76 10 80       	push   $0x80107678
...
80104e54:	68 77 76 10 80       	push   $0x80107677
...
801050cf:	e8 cc f7 ff ff       	call   801048a0 <create>
    if(ip == 0){
...
8010515f:	e8 3c f7 ff ff       	call   801048a0 <create>
...
801051ee:	e8 ad f6 ff ff       	call   801048a0 <create>
...
801054a4:	83 ec 10             	sub    $0x10,%esp
  int reads_;
  acquire(&readslock);
801054a7:	68 80 4c 11 80       	push   $0x80114c80
801054ac:	e8 8f ee ff ff       	call   80104340 <acquire>
  reads_ = reads;
801054b1:	8b 1d bc a5 10 80    	mov    0x8010a5bc,%ebx
  release(&readslock);
801054b7:	c7 04 24 80 4c 11 80 	movl   $0x80114c80,(%esp)
801054be:	e8 3d ef ff ff       	call   80104400 <release>
  cprintf("%d \n", reads_);
801054c3:	58                   	pop    %eax
801054c4:	5a                   	pop    %edx
801054c5:	53                   	push   %ebx
801054c6:	68 bd 76 10 80       	push   $0x801076bd
801054cb:	e8 90 b1 ff ff       	call   80100660 <cprintf>
  return reads_;
801054d0:	89 d8                	mov    %ebx,%eax
801054d2:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801054d5:	c9                   	leave  
801054d6:	c3                   	ret    
...
801055d0:	68 c0 4c 11 80       	push   $0x80114cc0
...
801055dd:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801055e0:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  while(ticks - ticks0 < n){
...
801055f3:	68 c0 4c 11 80       	push   $0x80114cc0
801055f8:	68 00 55 11 80       	push   $0x80115500
801055fd:	e8 7e e7 ff ff       	call   80103d80 <sleep>
  while(ticks - ticks0 < n){
80105602:	a1 00 55 11 80       	mov    0x80115500,%eax
...
80105620:	68 c0 4c 11 80       	push   $0x80114cc0
...
80105643:	68 c0 4c 11 80       	push   $0x80114cc0
...
80105664:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105667:	68 c0 4c 11 80       	push   $0x80114cc0
8010566c:	e8 cf ec ff ff       	call   80104340 <acquire>
  xticks = ticks;
80105671:	8b 1d 00 55 11 80    	mov    0x80115500,%ebx
  release(&tickslock);
80105677:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
...
801056c7:	c7 04 c5 02 4d 11 80 	movl   $0x8e000008,-0x7feeb2fe(,%eax,8)
801056ce:	08 00 00 8e 
801056d2:	66 89 14 c5 00 4d 11 	mov    %dx,-0x7feeb300(,%eax,8)
801056d9:	80 
801056da:	c1 ea 10             	shr    $0x10,%edx
801056dd:	66 89 14 c5 06 4d 11 	mov    %dx,-0x7feeb2fa(,%eax,8)
801056e4:	80 
  for(i = 0; i < 256; i++)
...
801056f4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801056f7:	c7 05 02 4f 11 80 08 	movl   $0xef000008,0x80114f02
801056fe:	00 00 ef 
  initlock(&tickslock, "time");
80105701:	68 c2 76 10 80       	push   $0x801076c2
80105706:	68 c0 4c 11 80       	push   $0x80114cc0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010570b:	66 a3 00 4f 11 80    	mov    %ax,0x80114f00
80105711:	c1 e8 10             	shr    $0x10,%eax
80105714:	66 a3 06 4f 11 80    	mov    %ax,0x80114f06
  initlock(&tickslock, "time");
...
8010573b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010573f:	b8 00 4d 11 80       	mov    $0x80114d00,%eax
...
80105983:	68 c0 4c 11 80       	push   $0x80114cc0
80105988:	e8 b3 e9 ff ff       	call   80104340 <acquire>
      wakeup(&ticks);
8010598d:	c7 04 24 00 55 11 80 	movl   $0x80115500,(%esp)
      ticks++;
80105994:	83 05 00 55 11 80 01 	addl   $0x1,0x80115500
      wakeup(&ticks);
8010599b:	e8 90 e5 ff ff       	call   80103f30 <wakeup>
      release(&tickslock);
801059a0:	c7 04 24 c0 4c 11 80 	movl   $0x80114cc0,(%esp)
...
801059d2:	68 c7 76 10 80       	push   $0x801076c7
...
80106820:	a1 04 55 11 80       	mov    0x80115504,%eax
{
...
80106cfb:	a3 04 55 11 80       	mov    %eax,0x80115504
  lcr3(V2P(kpgdir));   // switch to the kernel page table
